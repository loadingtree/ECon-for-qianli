...
void Float_to_U8(float FLoTin, uint8_t *U8out);
/* USER CODE END PFP */
...
/* USER CODE BEGIN 4 */
void Float_to_U8(float FLin, uint8_t *U8out)
{
...
float U8_to_Float(float* FLout, uint8_t *U8in)
{
